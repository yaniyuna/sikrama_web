        ...
        <Link
            ...
            className={`flex w-full items-start border-l-4 py-2 pe-4 ps-3 ${
                active
                    ...
                    : 'border-transparent text-gray-100 hover:border-gray-100 hover:bg-gray-50 hover:text-gray-200 focus:border-gray-300 focus:bg-gray-50 focus:text-gray-200 dark:text-gray-400 dark:hover:border-gray-100 dark:hover:bg-gray-100 dark:hover:text-gray-200 dark:focus:border-gray-100 dark:focus:bg-gray-700 dark:focus:text-gray-200'
